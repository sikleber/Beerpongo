...
**Important:** To use the correct api backend url in development mode the environment variable `REACT_APP_BEERPONGO_BACKEND_URL` has to be set on your machine. \
