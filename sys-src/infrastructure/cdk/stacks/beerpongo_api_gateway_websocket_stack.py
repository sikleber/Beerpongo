...
class BeerpongoApiGatewayWebsocketStack(Stack):
    def __init__(
        ...
        self.creat_game_route = self.web_socket_api.add_route(
            ...
            integration=WebSocketLambdaIntegration(create_game_route_config["id"], route_lambdas["createGameRoute"])
        )
        ...
        self.join_game_route = self.web_socket_api.add_route(
            ...
            integration=WebSocketLambdaIntegration(join_game_route_config["id"], route_lambdas["joinGameRoute"])
        )
        ...
        self.update_game_route = self.web_socket_api.add_route(
            ...
            integration=WebSocketLambdaIntegration(update_game_route_config["id"], route_lambdas["updateGameRoute"])
        )
